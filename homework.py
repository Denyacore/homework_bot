...
def parse_status(homework):
    ...
    if homework_status is None or homework_name is None:
        raise KeyError(f'В ответе API не найдены "homework_status" и "homework_name"')
...
def main():
    ...
    if check_tokens() == False:
        logger.critical(f'Нет одной из переменных окружения.\nПрограмма остановлена')
        raise exceptions.MissingVariable(f'Нет одной из переменных окружения.\nПрограмма остановлена')
